<div class="orderProducts index">
	...
	<tr>
		...
		<td><?php echo h($orderProduct['OrderProduct']['price']); ?>&nbsp;</td>
		<td><?php echo h($orderProduct['OrderProduct']['created']); ?>&nbsp;</td>
		<td><?php echo h($orderProduct['OrderProduct']['modified']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $orderProduct['OrderProduct']['id']), null, __('Are you sure you want to delete # %s?', $orderProduct['OrderProduct']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
