<?php
App::uses('OrderProductsController', 'Ecomm.Controller');

/**
 * OrderProductsController Test Case
 *
 */
class OrderProductsControllerTest extends ControllerTestCase {
